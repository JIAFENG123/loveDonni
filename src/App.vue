...
export default {
  ...
  methods: {
    transTime() {
      ...
      hour = new Date().getHours() + ""; //获取系统时，
      minite = new Date().getMinutes() + ""; //分
      ...
      let m1 = moment();
      //获取需要对比的时间
      let m2 = moment("20200502");
      //计算相差多少天 day可以是second minute
      this.loveDay = m1.diff(m2, "day");
    },
  },
};
</script>
